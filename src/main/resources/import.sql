...
-- ==========================================================
-- HIERARQUIA: Medico 1 (Dr. João Almeida)
INSERT INTO tb_pessoa (email, telefone) VALUES ('joao.almeida@clinica.com', '(21) 91111-3333');
INSERT INTO tb_pessoa_fisica (id_pessoa, nome, cpf) VALUES (3, 'João Almeida', '999.888.777-66');
...
-- ==========================================================
-- CONSULTAS
INSERT INTO tb_consulta (data, valor, observacao, paciente_id, medico_id) VALUES ('2024-11-15T10:30:00', 350.00, 'Primeira avaliação', 1, 3);
